              ...
              <div className={styles['profile-dropdown']}>
                ...
                <div className={styles['dropdown-section']}>
                  ...
                  <ul className={`${styles.subList} ${openSections.jobs ? styles.show : ''}`}>
                    <li onClick={() => navigate('/candidate/account/favoritesjobs')}>
                      Việc làm yêu thích
                    </li>
                    <li onClick={() => navigate('/candidate/account/appliedjobs')}>
                ...
                <div className={styles['dropdown-section']}>
                  <h4 onClick={() => toggleSection('peronal_settings')}>
                    ...
                    <ChevronRight
                      className={`${styles.arrowIcon} ${openSections.peronal_settings ? styles.open : ''}`}
                    />
                  </h4>

                  <ul
                    className={`${styles.subList} ${openSections.peronal_settings ? styles.show : ''}`}
                  >
                    <li onClick={() => navigate('/candidate/account')}>
                      Cài đặt thông tin cá nhân
                    </li>
                    <li onClick={() => navigate('/candidate/account/changepassword')}>
                      Đổi mật khẩu
                    </li>
                  </ul>
                </div>
                ...
                <div className={styles['dropdown-section']}>
                  <h4 onClick={() => toggleSection('general_settings')}>
                    ...
                    <ChevronRight
                      className={`${styles.arrowIcon} ${openSections.general_settings ? styles.open : ''}`}
                    />
                  </h4>

                  <ul
                    className={`${styles.subList} ${openSections.general_settings ? styles.show : ''}`}
                  >
                    <li onClick={() => navigate('/candidate/account/notifications')}>
                      Thông báo hệ thống
                    </li>
