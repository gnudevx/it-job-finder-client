...
export default function NewsSection() {
  const articles = [
    ...
    },
    {
      ...
      date: '7 Oct, 2025',
      readTime: '5 min read',
      author: 'formation, Sophie Novati',
      link: 'https://formation.dev/blog/how-technical-interviews-are-evolving-with-ai/',
    },
    {
      category: 'Interview',
      title: 'Top 30 câu hỏi phỏng vấn System Design tại Big Tech',
      desc: 'Tổng hợp bộ câu hỏi và hướng dẫn trả lời chi tiết cho các vị trí Backend/Fullstack level cao.',
      image: InterviewImage,
      date: '08 Oct, 2025',
      readTime: '10 min read',
      author: 'Roadmap, Ekene Eze',
      link: 'https://roadmap.sh/questions/system-design',
    },
  ];
      ...
      <div className={styles.container}>
        <div className={styles.header}>
          ...
          <p className={styles.subtitle}>
            Cập nhật xu hướng công nghệ, bí quyết phỏng vấn và lời khuyên phát triển sự nghiệp từ
            chuyên gia.
          </p>
        </div>
