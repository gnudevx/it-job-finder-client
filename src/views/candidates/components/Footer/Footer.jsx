        ...
        <div className={styles.grid}>
          ...
          <div className={styles.brand}>
            ...
            <p className={styles.brandDesc}>
              Nền tảng tuyển dụng công nghệ Việt Nam. Kết nối nhân tài với những cơ hội nghề nghiệp
              tốt nhất.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className={styles.linkList}>
              <li>
                <a className={styles.linkItem}>Đăng tin tuyển dụng</a>
              </li>
              <li>
                <a className={styles.linkItem}>Tìm kiếm hồ sơ</a>
              </li>
              <li>
                <a className={styles.linkItem}>Giải pháp nhân sự</a>
              </li>
              <li>
                <a className={styles.linkItem}>Báo giá dịch vụ</a>
              </li>
            </ul>
          </div>
