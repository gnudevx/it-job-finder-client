    ...
    <div className={styles.settingsContainer}>
      ...
      <div className={styles.settingBox} onClick={() => toggle('newDeviceLogin')}>
        <div className={styles.checkboxRow}>
          <div
            className={`${styles.checkboxCustom} ${security.newDeviceLogin ? styles.checked : ''}`}
          ></div>

          <div>
            <div className={styles.settingLabel}>Đăng nhập từ thiết bị mới</div>
      ...
      <div className={styles.settingBox} onClick={() => toggle('abnormalLogin')}>
        <div className={styles.checkboxRow}>
          <div
            className={`${styles.checkboxCustom} ${security.abnormalLogin ? styles.checked : ''}`}
          ></div>
      ...
      <div className={styles.settingBox} onClick={() => toggle('rememberSession')}>
        <div className={styles.checkboxRow}>
          <div
            className={`${styles.checkboxCustom} ${security.rememberSession ? styles.checked : ''}`}
          ></div>
