...
const NotificationPreview = ({ title, message, notifType }) => {
  ...
  const borderColor = (() => {
    switch (notifType) {
      case NotificationType.FEATURE:
        return styles.borderPurple500;
      case NotificationType.PROMOTION:
        return styles.borderYellow500;
      case NotificationType.ALERT:
        return styles.borderRed500;
      default:
        return styles.borderBlue500;
    }
  })();
  ...
  const iconColor = (() => {
    switch (notifType) {
      case NotificationType.FEATURE:
        return styles.textPurple600;
      case NotificationType.PROMOTION:
        return styles.textYellow600;
      case NotificationType.ALERT:
        return styles.textRed600;
      default:
        return styles.textBlue600;
    }
  })();
