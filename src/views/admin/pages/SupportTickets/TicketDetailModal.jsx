          ...
          <div className={styles.right}>
            <div className={styles.chatArea}>
              ...
              {ticket.replies?.map((reply) => {
                const isMe =
                  (isAdmin && reply.sender === 'ADMIN') || (!isAdmin && reply.sender === 'USER');
                return (
                  <div
                    key={reply.id}
                  ...
                  >
                    <div className={`${styles.avatar} ${isMe ? styles.avatarMe : ''}`}>
                      {reply.sender === 'ADMIN' ? <ShieldCheck size={16} /> : <User size={16} />}
                    </div>
                    <div className={`${styles.messageBubble} ${isMe ? styles.messageMe : ''}`}>
                      <p>{reply.content}</p>
