      ...
      <div className={styles.topCard}>
        <div className={styles.topCardRow}>
          <div className={styles.companyInfoRow}>
            <img src={logo} alt={recruiter.companyName} className={styles.companyLogo} />
            ...
            <div>
              ...
              <div className={styles.badgeRow}>
                <span
                  className={
                    recruiter.status === 'ACTIVE' ? styles.statusActive : styles.statusInactive
                  }
                >
                  {recruiter.status}
                </span>
          ...
          <div className={styles.actionColumn}>
            <div className={styles.actionRow}>
              <button className={styles.btnPrimary} onClick={() => setShowChangePassword(true)}>
                Đổi mật khẩu
              </button>
            </div>
            {showChangePassword && (
          ...
          <div className={styles.card}>
            ...
            <div className={styles.infoGrid}>
              ...
              <div>
                ...
                <span className={styles.creditBalance}>{recruiter.remaining}</span>
              </div>
                    ...
                    recruiter.jobs.map((job) => (
                      <tr key={job.id}>
                        ...
                        <td>
                          <span
                            className={
                              job.status === 'Open' ? styles.jobStatusOpen : styles.jobStatusClosed
                            }
                          >
                            {job.status}
                          </span>
              ...
              {!analysis ? (
                <div className={styles.aiInitial}>
                  <p className={styles.aiDesc}>
                    Sử dụng AI để đánh giá độ uy tín, phát hiện rủi ro và nhận đề xuất quản lý cho
                    nhà tuyển dụng này.
                  </p>
                ...
                <div className={styles.aiResult}>
                  ...
                  {/* Recommendations */}
                  <div>
                    <span className={styles.sectionTitle}>Đề xuất cho Admin</span>
