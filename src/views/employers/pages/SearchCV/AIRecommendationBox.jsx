      ...
      <div className={styles.card}>
        ...
        <div className={styles.header}>
          ...
          <p className={styles.subtitle}>
            Hãy dán bản mô tả công việc (JD) hoặc yêu cầu tuyển dụng. AI sẽ quét toàn bộ kho CV để
            tìm ra các bản hồ sơ có kỹ năng và kinh nghiệm tương xứng nhất.
          </p>
        </div>
        ...
        <div className={styles.body}>
          <div>
            <div className={styles.labelRow}>
              <label className={styles.label}>Nội dung Yêu cầu tuyển dụng</label>
              <span className={styles.hint}>Tối thiểu 20 từ để AI hoạt động tốt nhất</span>
            </div>
          ...
          <div className={styles.buttonWrapper}>
            <button
              ...
              className={`${styles.button} ${
                isAiLoading || !jobDescription.trim() ? styles.buttonDisabled : styles.buttonActive
              }`}
            >
              {isAiLoading ? (
                <>
