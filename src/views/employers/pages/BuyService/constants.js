export const PACKAGES = [
  {
    ...
    features: [
      ...
      { text: 'Gợi ý ứng viên', included: false },
    ],
    highlight: false,
  },
  {
    ...
    features: [
      ...
      { text: 'Module gợi ý ứng viên (Cơ bản)', included: true },
    ],
    highlight: true,
  },
  {
    ...
    features: [
      ...
      { text: 'Hiển thị tin vĩnh viễn', included: true },
...
export const INITIAL_TIPS = [
  {
    ...
    content:
      'Sử dụng các động từ mạnh và lợi ích rõ ràng ngay trong tiêu đề tin đăng để tăng 30% tỷ lệ click.',
    category: 'JD',
    aiGenerated: false,
  },
  {
    ...
    content:
      'Tin tuyển dụng công khai khoảng lương thường nhận được nhiều hơn 40% hồ sơ so với tin để "Thỏa thuận".',
    category: 'Sourcing',
    aiGenerated: false,
  },
];
