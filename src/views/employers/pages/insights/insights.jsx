    ...
    <div className={styles.section}>
      ...
      <div className={styles.banner}>
        <div className={styles.bannerContent}>
          ...
          <p className={styles.bannerText}>
            Cùng RecruitPro khám phá những bí kíp và thông tin hữu ích giúp bạn{' '}
            <span className={styles.highlight}>nâng cao hiệu quả tuyển dụng</span> và tìm kiếm những
            ứng viên xuất sắc.
          </p>
      ...
      <div className={styles.container}>
        <div className={styles.filters}>
          ...
          <button onClick={handleGenerateTip} disabled={loading} className={styles.aiBtn}>
            {loading ? (
          ...
          {filteredTips.length > 0 ? (
              ...
              <div key={tip.id} className={styles.tipCard}>
                ...
                <div className={styles.actions}>
                  <button className={styles.likeBtn}>
                    <ThumbsUp className={styles.iconSmall} /> Hữu ích
                  </button>
                  <button className={styles.dislikeBtn}>
                    <ThumbsDown className={styles.iconSmall} /> Không hữu ích
                  </button>
                </div>
              </div>
            ))
            ...
            <div className={styles.emptyState}>
              <div className={styles.emptyIcon}>
                <Info className={styles.iconLarge} />
              </div>
