  ...
  const tabs = [
    {
      icon: ImDropbox,
      key: 'all',
      label: 'Yêu cầu hỗ trợ & Báo cáo vi phạm',
      path: '/employer/support-box',
    },
    {
      icon: FaListCheck,
      key: 'suggest',
      label: 'Góp ý sản phẩm',
      path: '/employer/support-box/suggest',
    },
    {
      icon: TbMessageCircleUp,
      key: 'recruitment-consulting',
      label: 'Tư vấn tuyển dụng',
      path: '/employer/support-box/recruitment-consulting',
    },
    {
      icon: FaPhoneAlt,
      key: 'hotline',
      label: 'Hotline CSKH & Hỗ trợ dịch vụ',
      path: '/employer/support-box/hotline',
    },
  ];
  return (
