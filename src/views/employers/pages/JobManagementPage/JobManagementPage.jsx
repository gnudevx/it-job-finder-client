...
export default function JobManagementPage() {
  ...
  const filteredJobs = useMemo(() => {
    return jobs.filter((job) => {
      ...
      // 2. Filter visibility
      const matchVisibility = filters.visibility === 'all' || job.visibility === filters.visibility;

      // 3. Filter approval
      const matchApproval = filters.approval === 'all' || job.publishStatus === filters.approval;
