  ...
  const tabs = [
    {
      ...
      key: 'password',
      label: 'Đổi mật khẩu',
      path: '/employer/account/settings/password',
    },
    {
      icon: IoMdPerson,
      key: 'personal',
      label: 'Thông tin cá nhân',
      path: '/employer/account/settings/personal',
    },
    {
      icon: IoDocumentAttach,
      key: 'license',
      label: 'Giấy đăng ký doanh nghiệp',
      path: '/employer/account/settings/license',
    },
    {
      icon: IoIosBusiness,
      key: 'companyinfo',
      label: 'Thông tin công ty',
      path: '/employer/account/settings/company-info',
    },
    {
      icon: IoIosSettings,
      key: 'settings',
      label: 'Cài đặt',
      path: '/employer/account/settings/cv-applied',
    },
  ];
  return (
