...
import HisUpdateProduct from "@views/employers/components/Acctivities/HisUpdateProduct/HisUpdateProduct.jsx";
...
export default function AccountAcctivities() {
    const tabs = [
        ...
        { icon: CgBox, key: "hisUpdateProduct", label: "Lịch sử cập nhật SP", path: "/employer/account/activities/scout-point" },
            ...
            <div className={styles.accountContainer}>
                ...
                <div className={styles.content}>
                    <Routes>
                        ...
                        <Route path="scout-point" element={<HisUpdateProduct />} />
