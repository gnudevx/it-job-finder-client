...
export default function AccountAcctivities() {
  const tabs = [
    ...
    {
      icon: IoIosSettings,
      key: 'hisUpdateAccount',
      label: 'Lịch sử dụng cập nhật tài khoản',
      path: '/employer/account/activities/account-setting',
    },
    {
      icon: TbMessageCircleUp,
      key: 'hisReportCVSearch',
      label: 'Lịch sử báo cáo CV tìm kiếm',
      path: '/employer/account/activities/report-cv-search',
    },
    {
      icon: TbMessageCircleUp,
      key: 'hisReportCVRecommend',
      label: 'Lịch sử báo cáo CV đề xuất',
      path: '/employer/account/activities/report-recommend-cv',
    },
  ];
  return (
