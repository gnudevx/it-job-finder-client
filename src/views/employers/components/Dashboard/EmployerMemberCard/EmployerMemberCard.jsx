    ...
    >
      ...
      <div className={styles.rankSection}>
        ...
        <div className={styles.progressWrapper}>
          ...
          <div className={styles.progressDot} style={{ left: `calc(${progress}% - 10px)` }}>
        ...
        {!employer.isVerified && (
          <>
            <p className={styles.verifyNote}>
              Bạn cần đạt tối thiểu cấp độ xác thực <strong>2</strong> để thực hiện xét hạng khách
              hàng và sử dụng các quyền lợi tương ứng.
            </p>
