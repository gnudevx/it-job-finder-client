  ...
  return (
    <form className={styles.reportForm} onSubmit={handleSubmit}>
      ...
      <p className={styles.desc}>
        ...
        HireIT cho ra mắt Hộp thư hỗ trợ để lắng nghe tất cả các phản hồi từ phía Nhà tuyển dụng
        Doanh nghiệp về trải nghiệm khi sử dụng hệ thống. Những phản hồi chính xác của anh chị là cơ
        sở để HireIT cải tiến và nâng cao chất lượng sản phẩm.
      </p>
