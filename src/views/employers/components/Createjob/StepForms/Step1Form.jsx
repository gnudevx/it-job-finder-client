    ...
    <div className={styles.formContent}>
      ...
      <label className={styles.field}>
        ...
        {!validatedFields.title && (
          <div className={styles.errorText}> *Tiêu đề không được để trống</div>
        )}
      </label>
      ...
      <label className={styles.field}>
        ...
        {!validatedFields.specialization && (
          <div className={styles.errorText}>Vui lòng chọn vị trí chuyên môn</div>
        )}
      </label>
      ...
      <div className={styles.field}>
        ...
        <CreatableSelect
          ...
          placeholder={
            form.specialization
              ? 'Chọn hoặc nhập kiến thức ngành...'
              : 'Vui lòng chọn Vị trí chuyên môn trước'
          }
      ...
      <div className={styles.row}>
        <label className={`${styles.field} ${styles.fieldHalf}`}>
          ...
          {!validatedFields.jobType && (
            <div className={styles.errorText}>Vui lòng chọn loại công việc</div>
          )}
        </label>
