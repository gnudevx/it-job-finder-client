...
const PrivateRoute = ({ element }) => {
  ...
  if (authToken === null || authToken === undefined) return <Navigate to="/login" replace />;
    ...
    <>
      ...
      <Suspense fallback={<LoadingScreen />}>
        <Routes>
          ...
          {/* Candidate layout */}
          <Route path="/candidate/*" element={<PrivateRoute element={<CandidateApp />} />} />
          ...
          {/* Employer */}
          <Route path="/employer/*" element={<PrivateRoute element={<EmployerApp />} />} />
