...
const adminRoutes = [
  ...
  { path: 'manage/recruiment', element: <ManageRecruiment />, meta: { title: 'ManageRecruiment' } },
  {
    ...
    element: <ManageBusinessLicense />,
    meta: { title: 'ManageBusinessLicense' },
  },
  { path: 'manage/candidates', element: <ManageCandidates />, meta: { title: 'ManageCandidates' } },
  {
    path: 'manage/candidates/add',
    element: <CandidateForm mode="create" />,
    meta: { title: 'Thêm Candidate' },
  },
  {
    path: 'manage/candidates/:id',
    element: <EditCandidatePage mode="edit" />,
    meta: { title: 'Chỉnh Sửa Candidate' },
  },
  { path: 'manage/employers', element: <ManageEmployers />, meta: { title: 'ManageEmployers' } },
  {
    path: 'notification/candidate',
    element: <CandidateNotification targetAudience="CANDIDATE" />,
    meta: { title: 'CandidateNotification' },
  },
  {
    path: 'notification/employer',
    element: <EmployerNotification targetAudience="EMPLOYER" />,
    meta: { title: 'EmployerNotification' },
  },
  {
    path: 'manage/SupportTickets',
