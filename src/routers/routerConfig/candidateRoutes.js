...
const candidateRoutes = [
  ...
  {
    path: 'account/favoritesjobs',
    element: <FavoritesJobs />,
    meta: { title: 'Home', icon: 'home' },
  },
  { path: 'account/appliedjobs', element: <AppliedJobs />, meta: { title: 'Home', icon: 'home' } },
  {
    path: 'account/recommendjobs',
    element: <RecommendJobs />,
    meta: { title: 'Home', icon: 'home' },
  },
  { path: 'account/mycvs', element: <MyCVs />, meta: { title: 'Home', icon: 'home' } },
  {
    path: 'account/connectedemployer',
    element: <ConnectedEmployer />,
    meta: { title: 'Home', icon: 'home' },
  },
  {
    path: 'account/viewedemployer',
    element: <ViewedEmployer />,
    meta: { title: 'Home', icon: 'home' },
  },
